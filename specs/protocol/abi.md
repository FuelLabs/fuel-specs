...
## JSON Format for Storage Initializers
...
- `"initial_value"`: String, a 32-byte value that initializes the slot;
   ...
   [
      {
         ...
         "initial_value": "0x1010101010101010101010101010101010101010101010101010101010101010"
      }, 
      {
         "key": "0x2222222222222222222222222222222222222222222222222222222222222222",
         "initial_value": "0x2020202020202020202020202020202020202020202020202020202020202020"
      },
      {
         "key": "0x3333333333333333333333333333333333333333333333333333333333333333",
         "initial_value": "0x0303030303030303030303030303030303030303030303030303030303030303"
      },
   ]
}
```
