...
| Operation: | `$rd = MEM[$rs + offset]; advance_pc (4);` |
...
| Operation: | `$rd = (imm << 16); advance_pc();` |
| Syntax: | `lui $rd, imm` |
...
| Operation: | `$rd = $rs | imm; advance_pc();` |
...
| Operation: | `MEM[$rs + offset] = $rt; advance_pc();` |
...
| Operation: | `div $rs, $rt; mfhi $rd; advance_pc();` |
| Syntax: | `mod $rd, $rs, $rt` |
...
| Operation: | `sdiv $rs, $rt; mfhi $rd; advance_pc();` |
...
| Operation: | `add $rd, $rs, $rt; div $rd, $ru; mfhi $rd; advance_pc();` |
...
| Operation: | `mul $rd, $rs, $rt; div $rd, $ru; mfhi $rd; advance_pc();` |
...
| Operation: | `for (int i = 0; i < $rt) { mul $rd, $rd, $rs; }; advance_pc();` |
| Syntax: | `exp $rd, $rs, $rt` |
...
| Operation: | `div $rs, imm; mfhi $rd; advance_pc();` |
...
| Operation: | `sdiv $rs, imm; mfhi $rd; advance_pc();` |
...
| Operation: | `for (int i = 0; i < $rt) { mul $rd, $rd, imm; }; advance_pc();` |
...
| Operation: | `$rd = $gaslimit; advance_pc();` |
| Syntax: | `gaslimit $rd` |
...
| Operation: | `$rd = $gasprice; advance_pc();` |
| Syntax: | `gasprice $rd` |
...
| Operation: | `$rd = $balance[$rs]; advance_pc();` |
...
| Operation: | `$rd = $address; advance_pc();` |
| Syntax: | `address $rd` |
...
| Operation: | `$rd = $origin; advance_pc();` |
| Syntax: | `origin $rd` |
...
| Operation: | `$rd = $caller; advance_pc();` |
| Syntax: | `caller $rd` |
...
| Operation: | `$rd = $blockhash(MEM[$rs..$rs+8]); advance_pc();` |
...
| Operation: | `$rd = $coinbase; advance_pc();` |
| Syntax: | `coinbase $rd` |
...
| Operation: | `$rd = $timestamp; advance_pc();` |
| Syntax: | `timestamp $rd` |
...
| Operation: | `$rd = $number; advance_pc();` |
| Syntax: | `number $rd` |
...
| Operation: | `$rd = $difficulty; advance_pc();` |
...
| Operation: | `$rd = size($calldata); advance_pc();` |
...
| Operation: | `$rd = $calldata[$rs]; advance_pc();` |
...
| Operation: | `MEM[$rd] = $calldata[$rs..$rs+$rt]; advance_pc();` |
...
| Operation: | `$rd = $codesize($address); advance_pc();` |
| Syntax: | `codesize $rd` |
...
| Operation: | `MEM[$rd] = $code[$rs..$rs+$rt]; advance_pc();` |
...
| Operation: | `$rd = $codesize($rs); advance_pc();` |
...
| Operation: | `$rd = $codehash[$rs]; advance_pc();` |
...
| Operation: | `MEM[$rd] = $code[$ru][$rs..$rs+$rt]; advance_pc();` |
...
| Operation: | `$rd = size($returndata); advance_pc();` |
...
| Operation: | `MEM[$rd] = $returndata[$rs..$rs+$rt]; advance_pc();` |
...
| Operation: | `$log.push(: + MEM[$rs..$rs+$rt]); advance_pc();` |
| Syntax: | `log0 $rs, $rt` |
...
| Operation: | `$log.push($ru + : + MEM[$rs..$rs+$rt]); advance_pc();` |
...
| Operation: | `$log.push($ru + $rv + : + MEM[$rs..$rs+$rt]); advance_pc();` |
...
| Operation: | `$log.push($ru + $rv + $rw + : + MEM[$rs..$rs+$rt]); advance_pc();` |
...
| Operation: | `$log.push($ru + $rv + $rw + $rx + : + MEM[$rs..$rs+$rt]); advance_pc();` |
...
| Operation: | `if ($compare == 1) then nPC = imm; else advance_pc();` |
| Syntax: | `jumpif imm` |
| Encoding: | `10101011 ` |
| Notes: |  |
...
| Operation: | `if ($rs >= n) nPC = DATA[v_data_offset+n-1]; else nPC = DATA[v_data_offset+$rs]; ` |
...
| Operation: | `$callstack.push(PC+4); nPC = imm; ` |
| Syntax: | `jumpsub imm` |
| Encoding: | `10101101 ` |
| Notes: |  |
...
| Operation: | `if ($rs >= n) { $callstack.push(PC+4); nPC = DATA[v_data_offset+n-1]; } else { $callstack.push(PC+4); nPC = DATA[v_data_offset+$rs]; } ` |
...
| Operation: | `$rd = MEM[$rs+imm]; advance_pc();` |
...
| Operation: | `MEM[$rd] = MEM[$rs[rt[0]]...$rs[rt[rt.length()-1]]]; advance_pc();` |
...
#### <a name='op-group-id-140'/>Bitcoin: Proof mechanisms for MAST and Covenants
